                ...
                overrides:{
                    ...
                    "animate.less":{
                        "main" : ['source/animated.less', 'source/pulse.less', 'source/shake.less',
                                  'source/fadeInUp.less', 'source/fadeInLeft.less',
                                  'source/bounceIn.less', 'source/bounceOut.less',
                                  'source/bounceInLeft.less', 'source/bounceInRight.less',
                                  'source/bounceOutLeft.less','source/bounceOutRight.less',
                                  'source/fadeOutLeft.less','source/fadeOutRight.less']
                    }
                }
            },
            test: {
